...
const val BLUETOOTH_ADDRESS_ARDUINO = "00:19:5D:EE:40:53"
...
class MainActivity : AppCompatActivity(){
    ...
    private val myListClickListener = AdapterView.OnItemClickListener { av, v, arg2, arg3 ->
        ...
        //val i = Intent(this@MainActivity, ControlHumidityActivity::class.java)
        val i = Intent(this@MainActivity, ControlParamsActivity::class.java)
